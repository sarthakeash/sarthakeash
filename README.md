...
### Founding Engineer @ Entelligence.AI | CS'24 BITS Pilani
...
- 🤖 **Large Language Models** - Exploring the capabilities of cutting-edge LLMs
- 🧠 **Artificial Intelligence** - Developing solutions that leverage machine learning and deep learning
- ☁️ **Cloud Architecture** - Designing scalable and resilient cloud-native applications
- 🔄 **Distributed Systems** - Building reliable systems that work across multiple computers
